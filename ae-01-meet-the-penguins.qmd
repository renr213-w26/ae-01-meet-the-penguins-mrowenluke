...
-   **Demo:** First, replace the blank below with the number of rows in the `344` data frame based on the output of the chunk below. Then, replace it with "inline code" and render again.
